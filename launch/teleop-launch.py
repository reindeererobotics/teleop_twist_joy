...
def generate_launch_description():
    ...
    return launch.LaunchDescription([
        ...
        launch_ros.actions.Node(
            ...
            remappings={('/cmd_vel_arm', launch.substitutions.LaunchConfiguration('joy_vel_arm')), # remapping (from , to) & LaunchConfigurations are for cmd line args
                        ('/cmd_vel_base', launch.substitutions.LaunchConfiguration('joy_vel_base'))},
            ),
    ])
